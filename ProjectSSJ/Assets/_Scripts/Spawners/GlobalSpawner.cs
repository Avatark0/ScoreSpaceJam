...
public static class GlobalSpawner {
    private static float bug_start_time = 5;
    private static float platform_start_time = 15;
    private static float drop_start_time = 45;
    ...
    public static float platform_spawn_min_seconds = 4f;
    public static float platform_spawn_max_seconds = 7f;
    // That rate is increased by (time/30s);
    public static float platform_spawn_scaling_seconds = 25f;

    public static float drop_spawn_min_seconds = 4f;
    public static float drop_spawn_max_seconds = 9f;
    // That rate is increased by (time/30s);
    public static float drop_spawn_scaling_seconds = 20f;
